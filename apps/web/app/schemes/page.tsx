    ...
    <div className="min-h-screen bg-[#07090e] text-white pt-28 pb-20 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <section className="text-center space-y-4 max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight bg-gradient-to-r from-white via-white to-[#4F46E5]/80 bg-clip-text text-transparent">
          ...
          {CATEGORIES.map((category) => {
            ...
            return (
              <Link
                key={category.name}
                href={category.href}
                className="group relative flex flex-col justify-between p-6 h-[220px] rounded-[18px] border border-white/5 bg-white/[0.01] hover:bg-[#4F46E5]/[0.02] hover:border-[#4F46E5]/30 transition-all duration-300 shadow-[inset_0_1px_0_rgba(255,255,255,0.01)] hover:shadow-[0_12px_40px_-12px_rgba(99,102,241,0.15)] overflow-hidden"
              >
                {/* Visual grid pattern */}
                ...
                <div className="absolute -inset-px bg-gradient-to-br from-[#4F46E5]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-[18px] pointer-events-none" />
