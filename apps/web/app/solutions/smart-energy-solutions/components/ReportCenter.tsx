...
export function ReportCenter() {
  ...
  const reports: Report[] = [
    { id: "load", name: "HQ Building Peak Load Curve Log", desc: "Energy consumption profiles, thermal peak shaving offsets, and transient loads parameters.", size: "4.2 MB", type: "PDF" },
    { id: "forecast", name: "AI Predictive Demand & Generation", desc: "Meteorological solar index curves, factory load predictions, and EV queue forecasts.", size: "2.8 MB", type: "PDF" },
    { id: "quality", name: "Total Harmonics & Waveform Analytics", desc: "THD indicators, voltage sag indices, power factor correction parameters.", size: "1.5 MB", type: "PDF/Print" },
    { id: "vpp", name: "Virtual Power Plant Settlement Ledger", desc: "Distributed assets capacity logs, dynamic clearing price credit transactions.", size: "3.1 MB", type: "XLSX" },
    { id: "carbon", name: "Scope 2 ESG Green Index compliance", desc: "Carbon offsets certifications, unconsumed diesel equivalents, trees planted ratios.", size: "1.6 MB", type: "CSV" },
  ];
