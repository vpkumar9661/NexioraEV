...
export function ReportCenter() {
  ...
  const reports: Report[] = [
    { id: "battery-diag", name: "AI Battery Pack Lifetime & Health", desc: "LSTM forecasting, cell resistance sags, degradation curves, and warranty status assessments.", size: "4.2 MB", type: "PDF" },
    { id: "grid-bal", name: "Dynamic Grid Load & VPP Bidding", desc: "Energy arbitrage clearing prices, local microgrid generation yields, and V2G validation logs.", size: "6.5 MB", type: "XLSX" },
    { id: "fleet-savings", name: "ICE Fleet Savings & Telematics Audit", desc: "Regen braking efficiencies, range extension indices, driver scorecard summaries.", size: "3.8 MB", type: "PPT" },
  ];
              ...
              >
                <div className="space-y-1">
                  <div className="flex justify-between items-start">
                    <span className="text-[8px] font-bold text-black px-2 py-0.5 rounded bg-[#8B5CF6] uppercase tracking-widest">
                      {report.type}
                    </span>
                  ...
                  <p className="text-[10.5px] text-muted-foreground/75 leading-relaxed line-clamp-2">{report.desc}</p>
                </div>
