...
import { Bot, ShieldCheck, Zap, DollarSign, Activity, Compass, Award, RefreshCcw } from "lucide-react";
    ...
    >
      ...
      <div className="flex items-center justify-between mt-6 z-10 relative">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[10px] text-muted-foreground/40 font-bold">vs last hour</span>
        </div>
  ...
  const statsData: StatCardProps[] = [
    {
      ...
      glowColor: "#00D4FF",
      sparklinePoints: [71000, 73000, 75000, 77000, 80000, 81000, 83000, 84520],
    },
    {
      ...
      glowColor: "#00E676",
      sparklinePoints: [340000, 360000, 370000, 385000, 400000, 410000, 415000, 420800],
    },
    {
      label: "Battery Reports",
      value: "1,240 Sites",
      change: "+8.4%",
      changeType: "positive",
      icon: Activity,
      ...
      glowColor: "#8B5CF6",
      sparklinePoints: [1100, 1120, 1150, 1180, 1200, 1210, 1230, 1240],
    },
    {
      label: "Energy Savings Saved",
      value: "$145,280",
      change: "+16.2%",
      changeType: "positive",
      icon: DollarSign,
      ...
      glowColor: "#10B981",
      sparklinePoints: [120000, 125000, 130000, 132000, 138000, 140000, 142000, 145280],
    },
    {
      ...
      glowColor: "#F4B400",
      sparklinePoints: [99.78, 99.78, 99.78, 99.78, 99.78, 99.78, 99.78, 99.78],
    },
    {
      label: "Saved Hours Index",
      value: "3,480 hrs",
      change: "+480 hrs",
      changeType: "positive",
      icon: RefreshCcw,
      ...
      glowColor: "#A78BFA",
      sparklinePoints: [3000, 3050, 3100, 3150, 3200, 3300, 3400, 3480],
    },
  ];
