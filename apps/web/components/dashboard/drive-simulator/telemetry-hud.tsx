  ...
  return (
    <section id="telemetry" className="space-y-6 relative z-20">
      <div>
        ...
        <p className="text-xs text-[#AEB5C0]/60 mt-0.5">Real-time parameters tracing cells temperatures, rotor torque distributions, and current draws.</p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="p-4 rounded-[16px] border border-white/5 bg-white/2 space-y-2">
          <span className="text-[9.5px] text-[#AEB5C0]/40 font-bold uppercase tracking-wider block">Vehicle Speed</span>
          <div className="flex items-baseline justify-between">
            <strong className="text-2xl font-black text-white">{telemetry.speed}</strong>
            <span className="text-[10px] text-[#AEB5C0]/50 font-bold">km/h</span>
          </div>
        ...
        {/* Battery SOC */}
        <div className="p-4 rounded-[16px] border border-white/5 bg-white/2 space-y-2">
          <span className="text-[9.5px] text-[#AEB5C0]/40 font-bold uppercase tracking-wider block">State of Charge</span>
          <div className="flex items-baseline justify-between">
            <strong className="text-2xl font-black text-cyan-300">{telemetry.soc}%</strong>
            <span className="text-[10px] text-[#AEB5C0]/50 font-bold">{telemetry.range} km range</span>
          </div>
          <div className="w-full bg-white/5 h-1 rounded-full overflow-hidden">
        ...
        {/* Continuous Power */}
        <div className="p-4 rounded-[16px] border border-white/5 bg-white/2 space-y-2">
          <span className="text-[9.5px] text-[#AEB5C0]/40 font-bold uppercase tracking-wider block">Inverter Output</span>
          <div className="flex items-baseline justify-between">
            <strong className="text-2xl font-black text-white">{telemetry.power}</strong>
            <span className="text-[10px] text-[#AEB5C0]/50 font-bold">kW power</span>
          </div>
          <div className="w-full bg-white/5 h-1 rounded-full overflow-hidden">
        ...
        {/* Regen recovered */}
        <div className="p-4 rounded-[16px] border border-white/5 bg-white/2 space-y-2">
          <span className="text-[9.5px] text-[#AEB5C0]/40 font-bold uppercase tracking-wider block">Regenerative Recovery</span>
          <div className="flex items-baseline justify-between">
            <strong className="text-2xl font-black text-emerald-400">+{telemetry.regenRecovered.toFixed(2)}</strong>
            <span className="text-[10px] text-[#AEB5C0]/50 font-bold">kWh back</span>
          </div>
          <div className="w-full bg-white/5 h-1 rounded-full overflow-hidden">
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        ...
        <div className="p-4 rounded-2xl bg-black/40 border border-white/5 space-y-3">
          <div className="flex justify-between items-center text-xs">
            <span className="text-[#AEB5C0]/55 font-bold uppercase tracking-wider text-[9px] flex items-center gap-1">
        ...
        <div className="p-4 rounded-2xl bg-black/40 border border-white/5 space-y-3 flex items-center justify-between">
          <div className="space-y-1">
            <span className="text-[#AEB5C0]/55 font-bold uppercase tracking-wider text-[9px] block">Active Cooling Loop</span>
