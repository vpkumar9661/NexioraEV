...
export function ContinueCTA() {
  return (
    <section className="relative overflow-hidden rounded-[24px] border border-[#8B5CF6]/15 bg-gradient-to-br from-[#8B5CF6]/[0.06] via-transparent to-[#3B82F6]/[0.04] p-8 sm:p-12">
