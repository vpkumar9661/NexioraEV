  ...
  return (
    <section id="downloads" className="space-y-6">
      <div>
        ...
        <p className="text-sm text-[#AEB5C0]/60 mt-1">Free resources, guides, and research materials</p>
      </div>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11.5px] text-[#AEB5C0]/55 mt-1 line-clamp-2 leading-relaxed">{item.desc}</p>
                  <div className="flex items-center justify-between mt-3">
                    ...
                    <Download className="w-4 h-4 text-[#AEB5C0]/30 group-hover:text-[#A78BFA] transition-colors" />
                  </div>
                </div>
              </div>
            </div>
