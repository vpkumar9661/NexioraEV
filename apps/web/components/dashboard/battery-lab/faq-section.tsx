      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="relative w-full sm:w-[280px]">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2.5 rounded-xl bg-white/[0.03] border border-white/10 text-sm text-white placeholder:text-[#AEB5C0]/30 focus:outline-none focus:border-[#10B981]/40 focus:bg-[#10B981]/[0.03] transition-all"
          />
        </div>
      </div>
